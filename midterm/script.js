...
function submitData() {
    ...
    $("#displayArea").empty();
    appendData(firstName, lastName, phone, studentId, address, age, vehicle, gender, life);
}
// console.log($("displayArea"))
function appendData(firstName, lastName, phone, studentId, address, age, vehicle, gender, life){
